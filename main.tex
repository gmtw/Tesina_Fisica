...
Entonces si suponemos una presión $P = 2\times 10^{18} \, \mathrm{ergs} \cdot \mathrm{cm}^{-3}$, la densidad tendría que ser $\rho = 10^{-3} \, \mathrm{g} \mathrm{cm}^{-3}$
...
\hline 
$\rho_{in}$ &  Densidad interna de la onda expansiva & $10^{-3} \, [\mathrm{g} \cdot \mathrm{cm}^{-3}]$ \\ 
\hline 
$\rho_{out}$ &  Densidad del medio  & $10^{-10} \, [\mathrm{g} \cdot \mathrm{cm}^{-3}]$ \\
\hline 
$P_{int}$ & Presión interna de la onda expansiva & $2\times10^{18} \, [\mathrm{erg} \cdot \mathrm{cm}^{-3}]$ \\ 
\hline 
...
Al calcular la velocidad de la expansión del radio de la onda, tenemos un valor de 
...
\begin{figure}[H] 	
\centering
\subfigure[$t = 0.05$ s]{\includegraphics[scale = 0.15]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwhll-rel00}}
