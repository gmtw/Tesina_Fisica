...
Las pruebas del jet van a ser usando Lax, van a ser usando una densida $\rho_{jet}  = 100 \, g/\mathrm{cm}^2$, con una resolución de 500 pixeles. El tamaño de nuestro dominio será cuadado, con una longitud de $x = y = 1\times 10^9 \, \mathrm{cm}$
...
La siguiente prueba fue haciendo nuestro medio ambiente más denso, pero las condiciones del jet como presión y velocidad se mantuvieron iguales que en nuestra anterior prueba. El jet mostró mas dificultades al escapar debido a la densidad y presión más elevadas.
...
La siguiente parte fue usando el método de HLL, el cual ha mostrado ser un método más difícil de aplicar debido al tiempo de ejecución que lleva en un ordenador.

\begin{figure}[H] %Snapshot 20
\centering
\includegraphics[scale=0.5]{./Figuras/Pruebas/Prueba_jet/hll/jet_hll_100_ma_300} 
\caption{La imágen de HLL tiene una resolución de 250x250 píxeles y es aun más lento que Lax.}
\end{figure}

\begin{figure}[H] %Snapshot 20
\centering
\includegraphics[scale=0.5]{./Figuras/Pruebas/Prueba_jet/hll/jet_hll_100_ma_500} 
\caption{Esta prueba tiene una densidad de medio ambiente un poco mayor que en la anterior.}
\end{figure}
...
Para obtener la ecuación de Rankine-Hugoniot
