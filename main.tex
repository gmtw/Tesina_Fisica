...
\begin{figure}[H]
\centering
\subfigure[]{\includegraphics[width=0.5\textwidth]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwlax-rel0}}
\subfigure[]{\includegraphics[scale = 0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwlax-rel01}}
...
Al continuar viendo la evolución de la onda, es más difícil distinguir las ondas que se originan en el interior de la onda de choque, que como en el caso Newtoniano, ver figura \ref{fig:Lax-relativista-t-1.97}.

\begin{figure}[H]
\centering
\includegraphics[scale = 0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwlax-rel79}
\caption{Evolución de la onda al tiempo $t = 1.97$ s. Esta onda es la continuación del fenómeno que vimos en la figura \ref{fig:Lax-relativista}. La ondas que se generan son más difíciles de apreciar que en el caso newtoniano.} \label{fig:Lax-relativista-t-1.97}
\end{figure}
...
\begin{figure}[H]
\centering
{\includegraphics[scale=0.6]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwlax-rel79-analisis}}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwhll-rel79}
\caption{asda}
\end{figure}
