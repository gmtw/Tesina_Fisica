...
\begin{table}[htbp]
  ...
  \textbf{$v_{xi}$}/c & \textbf{$v_{xo}$}/c  & \textbf{$vy_i$}/c & \textbf{$vy_o$}/c  & 
...
compararán los perfiles radiales tomados a 0°, 45°, 90°. En la Figura \ref{fig:comparacion_perfil_velocidad}
el perfil de la densidad. Elpanel de arriba a la izquierda muestra a 0°, el de arriba a la derecha
a 90° y el de abajo muestra a 45°.

En la Figura, para los 3 perfiles radiales, muestran una densidad $\rho \approx 10$ en $x \approx 0.2$
donde comienza a disminuir hasta $\rho \approx 1.5$ en $x \approx 0.6$. Después comienza a subir hasta 
$\rho \approx 5$ para los perfiles de 90 y 0, mientras que para el de 45 sube hasta 5.5 en el punto
$x \approx 0.7$. Después vuelve a disminuir a $\rho \approx 0$ en el punto $x \approx 0.8$ para los 
3 perfiles radiales
...
Para el perfil de la velocidad (ver Figura \ref{fig:comparacion_perfil_velocidad}), 
en $x \approx 0.2$ la velocidad empieza a incrementar desde el reposo
$v = 0$ hasta $v \approx 0.7$ en $x \approx 0.6$, esto aplica para los 3 perfiles de velocidad. Después
va decreciendo hasta $v \approx 0.62$ en $x \approx 0.75$ para los perfiles de 0 y 90, mientras que para 
el perfil de 45 lo hace en $x \approx 0.73$. A partir de este punto la velocidad vuelve a cero.
...
El la figura \ref{fig:comparacion_perfil_presion} muestra el perfil de la presión, donde los paneles 
vienen ordenados de igual manera que el perfil de densidad y velocidad. Para el punto $x \approx 0.18$
la presión comienza a disminuir de $p = 13.33$ hasta $p \approx 1 $ en $x \approx 0.7$ para los 
3 perfiles. En $x \approx 0.71 $ vuelve a disminuir a $p = 0$ en $x \approx 0.74 $ para los perfiles de 
0 y 90, mientras que para el perfil de 45 lo hace en $x \approx 0.73 $.
