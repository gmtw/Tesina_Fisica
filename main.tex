...
{\color{red}Los valores d $\rho$, $p$ y $v$ de los modelos newtonianos se indican en el cuadro
...
usando Lax con distintas resoluciones ($nx = 10^2, \, 10^3, \,10^4$), ademas, se muestra la solución
analítica.}
Queda claro como 
...
\begin{table}[htbp]
  ...
  de la presión ($p$), velocidad ($v$)
  y densidad ($\rho$), del lado interno ($p_i, v_{xi}, v{yi}, \rho_i$) y 
...
{\color{red} Al comparar los perfiles bidimensionales con el analítico, para la densidad se tiene un error 
máximo del
13 \%, para la velocidad del 12 \% y para la presión del 16 \%. Para el caso unidimensional
con el analítico, el error máximo para la $\rho$, $v$ y $p$ son 
3 \%,  7\% y  4 \% respectivamente.}
