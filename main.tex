...
apenas un ancho aproximado de 2. Para el tiempo $t = 20$ el jet se espande a 
$x \approx 10$. El ancho del capullo ahora es de 
4, las ondas colimación no cambian, mantienen su posición en $x \approx 4$ a lo largo del eje $y = 10$. 
...
tamaño en $x \approx 4$ y el capullo se incrementa a 5.
}
...
y las gráficas en alta densidad (derecha). Los páneles de arriba muestran al tiempo t = 40 mientras que los de abajo al tiempo
t = 80}
% {\color {red}FALTA EXPLICAR MAS CADA UNO DE TUS PANELES, LA DISTANCIA EN X EN CADA TIEMPO, 
% A ESTRUCTURA DEL JET (JET, COCOON, ONDAS DE COLIMACION...).}
...
La figura \ref{fig:Decaimiento_densidad_jet} muestra los perfiles de densidad, velocidad y presión, es decir, solo mostrará 
los valores que esten sobre $y = 10$ de la Figura \ref{fig:evolucion_temporal_del_jet_densidad_variable}. En el panel de arriba 
...
\begin{figure}
  ...
  linea punteada). Los colores son para diferenciar los tiempos.}}\label{fig:Decaimiento_densidad_jet}
\end{figure}
