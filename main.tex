...
{\color{red}{Podemos concluir, para el caso newtoniano, que nuestros módulos de 
...
{\color{red}Por lo tanto podemos concluir que nuestro módulo HLL se ajusta perfectamente para el problema de 
...
como funciona en 2 dimensiones.
