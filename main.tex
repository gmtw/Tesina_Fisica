...
\caption{Al desvanecerse casi por completo la onda se puede notar una mayor diferencia que hay entre ambos métodos, sobre todo en el centro de la onda.} \label{fig:Lax-hll-newtoniano2}
\end{figure}
...
En las coordenadas $(x,y) = (0.5, 0.0)$ se puede ver que el algoritmo de Lax tiene algunos errores puesto que el centro de la onda se deforma en estos puntos, mientras que hll es casi imperceptible

\begin{figure}[H]
\centering
\subfigure[$t = 0.2$ s]{\includegraphics[scale = 0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwlax4}}
\subfigure[$t = 0.2$ s]{\includegraphics[scale = 0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwhll4}}
...
Otra diferencia que se nota es que el centro de HLL es más difuso que el de Lax y que esta última es más circular que HLL

\begin{figure}[H]
\centering
\subfigure[$t = 0.12$ s]{\includegraphics[scale = 0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwlax10}}
\subfigure[$t = 0.12$ s]{\includegraphics[scale = 0.5]{./Figuras/Pruebas/Prueba_onda_choque/Lax-HLL-rel/bwhll10}}
\caption{El centro de ambas ondas difieren significativamente} \label{fig:Lax-hll-relativista}
\end{figure}
