...
\caption{\label{fig:velocidades_baja}Eyección del jet relativista al tiempo $t = 0.1$ s. La velocidad que ocasiona el jet al medio ambiente es $v_y \sim 0.97\mathrm{c} \, \mathrm{cm} \cdot \mathrm{s}^{-1}$}
\end{figure}
%====================================FIGURE==============================================
...
\caption{\label{fig:jet_vel_alto}Eyección del jet relativista al tiempo $t = 0.8$ s. La velocidad en el centro del jet se mantiene en la misma velocidad $v \sim 0.97\mathrm{c} \, \mathrm{cm} \cdot \mathrm{s}^{-1}$} 
\end{figure}
%====================================FIGURE==============================================
