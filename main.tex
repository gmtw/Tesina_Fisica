...
\caption{\label{fig:velocidades_baja}Perfil de velocidad del jet. La gráfica muestra la velocidad del jet jet y medio ambiente que existe en la recta $x = 5\times 10^9$ al tiempo $t = 0.1$ s. La velocidad que ocasiona el jet al medio ambiente es $v_y \sim 0.97\mathrm{c} \, \mathrm{cm} \cdot \mathrm{s}^{-1}$.}
\end{figure}
%====================================FIGURE==============================================
...
\caption{\label{fig:jet_vel_alto}Perfil del jet relativista al tiempo $t = 0.8$ s. La velocidad en el centro del jet se mantiene en la misma velocidad $v \sim 0.97\mathrm{c} \, \mathrm{cm} \cdot \mathrm{s}^{-1}$} 
\end{figure}
%====================================FIGURE==============================================
...
\caption{\label{fig:velocidades_alta} Perfil de velocidad del jet con el medio de densidad alto al tiempo $t = 0.1$ s. La velocidad del jet baja rápidamente $v = 7000 \, \mathrm{cm} \cdot \mathrm{s}^{-1}$.}
\end{figure}
%====================================FIGURE==============================================
