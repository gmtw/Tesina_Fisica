...
\begin{table}[htbp]
  ...
  \textbf{$vx_i$}/c & \textbf{$vx_o$}/c  & \textbf{$vy_i$}/c & \textbf{$vy_o$}/c  & 
  ...
  de la presión ($p$), velocidad ($v$)
  y densidad ($\rho$), del lado interno ($p_i, vx_i, vy_i, \rho_i$) y 
  externo ($p_o, vx_o, vy_o, \rho_o$) de la onda de choque
  para los casos relativistas. Para todos los
...
\begin{figure}
  \centering
    \includegraphics[width=0.5\textwidth]{./Figuras/verificacion_del_codigo/pruebas_2D/Example.png}
  \caption{Las flechas indican los perfiles de densidad, velocidad y presión se 
...
En la Figura \ref{fig:comparacion_perfil_0} muestra la comparación entre la prueba unidimensional
y la prueba bidimensional, la cual usa el perfil radial que es paralelo al eje x (0°).
...
\begin{figure}
  \centering
      \subfigure{\includegraphics[scale = 0.17]{./Figuras/verificacion_del_codigo/pruebas_2D/0/densidad.png}}
      \subfigure{\includegraphics[scale = 0.17]{./Figuras/verificacion_del_codigo/pruebas_2D/0/velocidad.png}}
      \subfigure{\includegraphics[scale = 0.17]{./Figuras/verificacion_del_codigo/pruebas_2D/0/presion.png}}
    \caption{La figura muestra la comparación que hay entre la prueba unidimensional 
    (lineal roja punteada) y la prueba 
    bidimensional (lineal azul sólida), la cual usa el perfil radial que es paralelo al eje x (0°). El panel de arriba a la 
    izquierda muestra la densidad, el de arriba a la derecha la velocidad y el de abajo la presión
    Ambas pruebas se usaron tomando en cuenta los valores del Cuadro \ref{Cuadro_parametros_choque_2D}
    y al tiempo $t = 0.4$ s}
    \label{fig:comparacion_perfil_0}
\end{figure}
En la Figura \ref{fig:comparacion_perfil_90} se compara los perfiles radiales que son ortogonales al
eje x, basicamente esta Figura viene siendo lo mismo que la Figura \ref{fig:comparacion_perfil_0}.
El panel de arriba a la izquierda muestra la densidad, el de arriba a la derecha, la velocidad y 
el de abajo la presión.
La densidad y presión, para ambas pruebas, mantienen sus valores de 
$\rho = 10 \,  \text{g}/ \text{cm}^3$ y $p = 13.33 \,  \text{dyn}/ \text{cm}^2 $ 
...
\begin{figure}
  \centering
    ...
    \caption{Igual que la Figura \ref{fig:comparacion_perfil_0}, solo que se tomó un perfil radial
    ortogonal al eje x (90°).}\label{fig:comparacion_perfil_90}
\end{figure}
En la Figura \ref{fig:comparacion_perfil_45} se compara los perfiles radiales que 
estan inclinados 45° respecto al
eje x
La densidad y presión, para ambas pruebas, mantienen sus valores de 
$\rho = 10 \,  \text{g}/ \text{cm}^3$ y $p = 13.33 \,  \text{dyn}/ \text{cm}^2 $ 
luego, bajan sus valores en $x \approx 0.25$
...
La densidad en 1D  vuelve a subir
en $x \approx 0.69$ cm y llega a $\rho \approx 5 \,  \text{g}/ \text{cm}^3$,
mientras que en 2D, llega a $\rho \approx 5 \,  \text{g}/ \text{cm}^3$ y 
se mantiene así hasta el punto $x \approx 0.7$ cm 
donde la densidad, así como la velocidad y presión descienden sus valores a nulos.
\begin{figure}
  \centering
    ...
    \caption{Igual que la Figura \ref{fig:comparacion_perfil_0}, solo que se tomó un perfil radial
    inclinado 45° sobre el eje de las x.}\label{fig:comparacion_perfil_45}
\end{figure}
