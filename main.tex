...
\hline 
$\rho_{a}$ &  Densidad del medio ambiente & {\color{red} $10^4$ REVISAR ESTE DATO}   \\
\hline 
...
La presión no tiene un máximo local al tiempo t = 5, aunque si un cambio menos abrupto en $x = 3$. 
{\color{blue} En los tiempos t = 20, 50 los máximos globales se situan en $x \approx 12$ y en $x \approx 33$}.
