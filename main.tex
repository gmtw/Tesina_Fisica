...
La evolución de la onda usando relatividad, fue más lenta que la newtoniano, su expansión al tiempo $t = 0.05$ s es de $r = 0.26$ cm, y una velocidad $\vec{v} = 1.34 \, \mathrm{cm}/\mathrm{s}$, para el tiempo $t = 0.1$ s, el radio de la onda se expandió a $r = 0.31$ cm y su velocidad correspondiente es de $\vec{1.1 \, \mathrm{cm}/\mathrm{s}}$, se pueden ver 2 ondas una contra el medio y otra en reversa que va dirigida hacia el centro provocando un vacío en el centro de la onda.
...
\begin{eqnarray}
\textbf{U}(0,i)&=&\textbf{U}(1,i) \\
\textbf{U}(n+1,i)&=&\textbf{U}(n,i) \\
\textbf{U}(j,0)&=&\textbf{U}(j,1) \\
\textbf{U}(j,m+1)&=&\textbf{U}(j,m) 
\end{eqnarray}
