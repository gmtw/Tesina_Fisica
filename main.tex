...
$\rho_a = 0.1 g cm^{-1}$ y $P_a = 0.01 erg cm^{-3}$. 
...
usa es 0.5 y el tiempo de integración es hasta $t = 80$. Los valores dl jet y su medio ambiente son los
...
los mismos tiempos y escalas de densidad, en comparación con los resultados de Mignone (2005). 
El panel de arriba muestra la comparación (páneles izquierdos: Mignone (2005), páneles derechos: 
este estudio) al tiempo t = 40 s, y t = 46 s. 
...
$x \approx z \approx 18$. Los choque de climación son más grandes en el estudio de Mignone que en este dado
que se localizan en $r \approx 7$ cm y $x \approx 5$ cm }
