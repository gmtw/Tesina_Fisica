...
Usando esto podemos tomar valores de la presión en función de la densidad del jet.
...
\begin{figure}\
\centering
\subfigure[Lax]{\includegraphics[scale=0.15]{./Figuras/densidad_de_medios_ambientes/medio_bajo/jet_lax_5_ma_01^-10}}
\subfigure[Lax]{\includegraphics[scale=0.15]{./Figuras/densidad_de_medios_ambientes/medio_bajo/jet_lax_5_ma_03^-10}}
\subfigure[Lax]{\includegraphics[scale=0.15]{./Figuras/densidad_de_medios_ambientes/medio_bajo/jet_lax_5_ma_05^-10}}
...
Al realizar un campo vectorial de las velocidades del jet (ver Figura \ref{fig:jet_ma_bajo_densidad_vel}) de la parte de eyección de la frontera, la velocidad en sus extremos $v_{y} = 0.97354 c \, \mathrm{cm} \cdot \mathrm{s}^{-1}$ con lo que la velocidad baja un 0.63\% con respecto a la velocidad que se habia establecido en el jet. La velocidad en el eje x es $v_{x} = 0.1745 \, c$ con esto puedo concluir que a pesar de que el jet no tenga velocidades en el eje X, la densidad del medio ambiente influye en como el jet se desvia un 17 \% la velocidad para el eje X. Con estas velocidades en el eje X e Y puedo concluir que el jet, a pesar de ser colimado, tiene un ángulo con respecto al jet de $\theta  = 10.16^{o}$.


%====================================FIGURE==============================================
\begin{figure}
\centering
\subfigure[Lax]{\includegraphics[scale=0.275]{./Figuras/densidad_de_medios_ambientes/medio_bajo/vel_lax_b01}}
\subfigure[Lax]{\includegraphics[scale=0.275]{./Figuras/densidad_de_medios_ambientes/medio_bajo/vel_lax_b03}}
\subfigure[Lax]{\includegraphics[scale=0.275]{./Figuras/densidad_de_medios_ambientes/medio_bajo/vel_lax_b05}}
\caption{\label{fig:jet_ma_bajo_densidad_vel}Eyección del jet relativista al tiempo $t = 0.05$ s. Debido a la poca densidad del medio ambiente que lo rodea no hay una formación del capullo, además de que el jet es colimado.}
\end{figure}
%====================================FIGURE==============================================


La velocidad en la Figura \ref{fig:velocidades_baja} del medio ambiente cuando interactua con el jet toma una velocidad similar que las condiciones iniciales con las que habiamos impuesto al jet, es decir, tienen una velocidad $v = 0.97\mathrm{c} \,\mathrm{cm} \cdot \mathrm{s}^{-1}$.
...
\begin{figure}
\centering
\subfigure[Lax]{\includegraphics[scale=0.15]{./Figuras/densidad_de_medios_ambientes/medio_alto/jet_lax_20_ma_10^-10}}
\subfigure[Lax]{\includegraphics[scale=0.15]{./Figuras/densidad_de_medios_ambientes/medio_alto/jet_lax_50_ma_10^-10}}
\subfigure[Lax]{\includegraphics[scale=0.15]{./Figuras/densidad_de_medios_ambientes/medio_alto/jet_lax_80_ma_10^-10}}
\caption{\label{fig:jet_ma_alto_densidad}Eyección del jet relativista al tiempo $t = 0.05$ s. Debido a la poca densidad del medio ambiente que lo rodea no hay una formación del capullo, además de que el jet es colimado.}
\end{figure}
%====================================FIGURE==============================================
...
\begin{figure}
\centering
\subfigure[Lax]{\includegraphics[scale=0.275]{./Figuras/densidad_de_medios_ambientes/medio_alto/vel_lax_a20}}
\subfigure[Lax]{\includegraphics[scale=0.275]{./Figuras/densidad_de_medios_ambientes/medio_alto/vel_lax_a50}}
\subfigure[Lax]{\includegraphics[scale=0.275]{./Figuras/densidad_de_medios_ambientes/medio_alto/vel_lax_a80}}
\caption{\label{fig:jet_ma_alto_densidad}Eyección del jet relativista al tiempo $t = 0.05$ s. Debido a la poca densidad del medio ambiente que lo rodea no hay una formación del capullo, además de que el jet es colimado.}
\end{figure}
%====================================FIGURE==============================================
