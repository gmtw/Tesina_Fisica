...
\subsubsection{Rankine-Hugoniot Relativista}
...
Donde $V_j$, $V_\infty$ es el volumen del jet y del medio que lo rodea respectivamente, despejando $\rho_{\infty}$ obtenemos:
...
La ecuación de conservación de masa tambien se puede reescribir como:

\begin{equation}\label{eq_masa_relativista_modificada}
  \frac{v_j \gamma_j}{V_j}= \frac{v_{\infty} \gamma_{\infty}}{V_{\infty}}
\end{equation}

Con la ecuación \ref{eq_masa_relativista_modificada} podemos modificar la ecuación \ref{eq_momentos_relativista_modificada}, con lo que nos queda:
...
\section{Desacoplamiento de las ecuaciones de la hidrodinámica relativista} \label{Cap_Desacoplamiento_de_las_ecuaciones_de_la_hidrodinámica_relativista}
