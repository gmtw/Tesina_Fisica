...
\caption{\label{fig:onda_choque4_t_0}Onda de choque en el tiempo $t = 0$, los valores con los que fue suministrado nuestra onda de choque son los mismos que se habian propuesto en el Cuadro \ref{Tabla_parametros} }
\end{figure}
%===================IMAGE_HLL_NO_CENTRADO_T=0===============================
...
\begin{figure}
\centering
\subfigure[t = 0.05 s]{\includegraphics[scale = 0.3]{./Figuras/Pruebas/perfil_radial/perfil_radial_1}}
\subfigure[t = 0.5 s]{\includegraphics[scale = 0.3]{./Figuras/Pruebas/perfil_radial/perfil_radial_2}}
\subfigure[t = 0.75 s]{\includegraphics[scale = 0.3]{./Figuras/Pruebas/perfil_radial/perfil_radial_4}}
