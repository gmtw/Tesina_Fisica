...
\begin{figure}
  \centering
    ...
    el código HLL relativista al tiempo t = 40 s. El panel de abajo a la izquierda 
...
de arriba se muestra que el jet de estudio tiene casi el mismo ancho que el de Mignone dado 
que el ancho del jet llega a aproximadamente 14 cm, mientras que el de este estudio, su ancho, se expande
a 15 cm lo que hace ue este jet siga siendo todavia más viscoso. Las ondas de colimación 

\begin{figure}
  \centering
      \subfigure{\includegraphics[scale = 0.3]{./Figuras/jet/comparacion/40_m.png}}
      \subfigure{\includegraphics[scale = 0.3]{./Figuras/jet/comparacion/46_b&w_HD.png}}
      \subfigure{\includegraphics[scale = 0.3]{./Figuras/jet/comparacion/80_m.png}}
      \subfigure{\includegraphics[scale = 0.3]{./Figuras/jet/comparacion/82_b&w_HD.png}}
    \caption{Compración entre el jet relativista modelado por nuestro código HLL
    ...
    muestra el de Mignone al tiempo t=80 s, mientras que el de la derecha, el HLL relativista al 
    tiempo t = 82 s.}\label{fig:comparacion_temporal_del_jet_HD}
\end{figure}
