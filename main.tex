...
La onda de Lax al tiempo $t = 0.05$ s tiene un radio $r=0.31$ cm y una velocidad $v = 2.2 \, \mathrm{cm}/\mathrm{s}$, mientras que la onda de HLL tiene un radio $r = 0.31$ y una velocidad $v = 2.2 \, \mathrm{cm}/\mathrm{s}$.
...
Al avanzar la onda, al tiempo $t = 0.2$ en ambos métodos se sigue mostrando 2 ondas una contra el medio y una contra el centro, el radio para Lax $r = 0.39$cm su velocidad $v = 0.95 \, \mathrm{cm}/\mathrm{s}$ el radio usando HLL es de $r = 0.39$ cm y su velocidad $v = 0.95 \, \mathrm{cm}/\mathrm{s}$
\begin{figure}[H]
\centering
