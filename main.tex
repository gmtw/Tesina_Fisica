...
\begin{figure}
  \centering
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/evolucion/20.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/evolucion/40.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/evolucion/60.png}}
    ...
    y el de abajo muestra al tiempo t = 60 }\label{fig:evolucion_temporal_del_jet}
\end{figure}
...
\begin{figure}
  \centering
    \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/40_m.png}}
    \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/40_b&w_log_scale_2.png}}
    \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/80_m.png}}
    \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/78_b&w_log_scale_2.png}}
    \caption{Compración entre el jet relativista modelado por nuestro código HLL
    relativista y el modelo de Mignone \emph{et. al} (2005). El panel de arriba a la izquierda 
    ...
    muestra el de Mignone al tiempo t=80, mientras que el de la derecha, el HLL relativista, al 
    tiempo t = 78.}\label{fig:comparacion_temporal_del_jet}
\end{figure}
...
\begin{figure}
  \centering
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/40_m.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/40_b&w_log_HD_scale_2.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/80_m.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/comparacion/80_b&w_log_HD_scale_2.png}}
    \caption{Compración entre el jet relativista modelado por nuestro código HLL
    ...
    al tiempo t = 80.}\label{fig:comparacion_temporal_del_jet_HD}
\end{figure}
...
\begin{figure}
  \centering
    \includegraphics[width=0.5\textwidth]{./Figuras/jet/densidad_variable/densidad_variable.png}
...
\begin{figure}
  \centering
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/densidad_variable/20.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/densidad_variable/40.png}}
      \subfigure{\includegraphics[scale = 0.2]{./Figuras/jet/densidad_variable/60.png}}
    \caption{Evolución del jet relativista con los valores del Cuadro 
