...
En el panel de arriba a la derecha se muestra una densidad $\rho \approx 10$ en $x \approx 0.2$
...
El el panel de abajo muestra el perfil de la presión. Para el punto $x \approx 0.18$
...
Al comparar las gráficas, se puede ver que los perfiles de 0 y 90, tiene un error del 0 \% mientras que
al compararse con el de 45 vemos que ... (verificar resultados).
