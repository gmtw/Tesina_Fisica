...
\begin{figure}
  \centering
    \includegraphics[width=0.5\textwidth]{./Figuras/verificacion_del_codigo/Radio_vs_tiempo_computacionalmente.png}
  \caption{Velocidad del radio de expansión de una onda de choque conforme avanza el tiempo. Se empleo el método de Lax dada su rapidez con la que se calculaba
