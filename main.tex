...
programa, con distintos medios de densidad.
...
al tiempo $t = 40$ s mientras que el de anajo muestra el tiempo $t = 60$ s.
...
En la Figura \ref{fig:comparacion_temporal_del_jet} se muestra la comparación del código que se ha implementado
asta ahorita, que es el HLL relativista, contra el de Mignone. El panel de arriba muestra la comparación del
de Mignone al tiempo t = 40 s (izquierda) y  el HLL relativista al tiempo t = 46 s. El panel de abajo es
similar a los aspectos del panel de arriba con excepción de qie los tiempos son t = 80 (izquierda) y 
t = 82 s. Podemos observar que hay un error en los tiempos 15 \% y que al incrementarse este se reduce al
